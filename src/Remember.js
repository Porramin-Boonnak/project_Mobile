        ...
        <View style={{ flex: 1 }}>
            ...
            {!next ?
                <View style={{ flexDirection: "row", flex: 1, padding: 20, alignItems: "center", justifyContent: "space-around" }}>
                    <TouchableOpacity onPress={() => { cardRef.current?.flipCard(); setnext(true) }} style={{ width: 120, height: 120, borderWidth: 1, borderRadius: 60, justifyContent: "center", alignItems: "center" }}>
                        <FontAwesome6 name="x" size={50} color="black" />
                    </TouchableOpacity>
                    <TouchableOpacity onPress={() => { cardRef.current?.flipCard(); setnext(true) }} style={{ width: 120, height: 120, borderWidth: 1, borderRadius: 60, justifyContent: "center", alignItems: "center" }}>
                        <FontAwesome6 name="check" size={50} color="black" />
                    </TouchableOpacity>
                </View>
                : <View style={{ flexDirection: "row", flex: 1, padding: 20, alignItems: "center", justifyContent: "space-around" }}>
                    <TouchableOpacity onPress={() => { cardRef.current?.flipCard(); setcurrent(current + 1); setnext(false) }} style={{ width: 120, height: 120, borderWidth: 1, borderRadius: 60, justifyContent: "center", alignItems: "center" }}>
